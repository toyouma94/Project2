	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement1" value="value" checked="checked" onclick="return false">이용약관과 개인정보취급방침에 동의합니다.</p>
