...
<script type="text/javascript">
	var checkValue = function(frm) {
		...
		if (!idRegExp.test(frm.id.value)) {
			alert('아이디가 조건에 맞지 않습니다');
			frm.id.focus();
			return false;
		} else if (!eng.test(frm.id.value) || !num.test(frm.id.value)) {
			alert('아이디가 조건에 맞지 않습니다');
			frm.id.focus();
			return false;
		}
	...
	// 아이디 중복체크 화면open
	function openIdChk(frm) {

		var num3 = /[0-9]/g;
		var idRegExp3 = /^[a-z0-9]{4,12}$/;
		var eng3 = /[a-z]/g;
		if (frm.id.value == '') {
			alert('아이디를 입력하세요');
			frm.id.focus();
		...
		if (!idRegExp3.test(frm.id.value)) {
			alert('아이디가 조건에 맞지 않습니다');
			frm.id.focus();
			return false;
		} else if (!eng3.test(frm.id.value) || !num3.test(frm.id.value)) {
			alert('아이디가 조건에 맞지 않습니다');
			frm.id.focus();
			return false;
		}
		...
		window.open("IdCheckForm.jsp?id=" + id, "chkForm",
		...
		<div id="wrap">
			...
			<div class="contents_box">
				...
				<div class="right_contents">
					...
					<form action="../member/write" name="registForm" id="registForm"
						...
						<table cellpadding="0" cellspacing="0" border="0" class="join_box">
							...
							<tr>
								...
								<td><input type="text" name="id" class="join_input"
									maxlength="50" onkeydown="inputIdChk()" style="cursor: hand;">
									<input type="hidden" name="idDuplication" value="idUncheck">
									<input type="image" src="../images/btn_idcheck.gif" alt="중복확인"
									onclick="return openIdChk(this.form);" /> </a>&nbsp;&nbsp;<span>*
